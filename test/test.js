const Shapes = require("../dist/Shape").Shapes;
const Point = require("../dist/Shape").Point;
const Shape = require("../dist/Shape").Shape;
const Rectangle = require("../dist/Shape").Rectangle;
const Ellipse = require("../dist/Shape").Ellipse;
const Circle = require("../dist/Shape").Circle;
const Square = require("../dist/Shape").Square;
...
describe("Testing shapes classes", () => {
  ...
  it("can create Rectangle & toString() return value expected", () => {
    ...
    let str = "name: RE, location: (12,34), w: 56, h: 78"
      .replace(/\s/g, "")
      .toLowerCase();
  ...
  it("can create Ellipse & toString() return value expected", () => {
    ...
    let str = "name: RE, location: (12,34), a: 56, b: 78"
      .replace(/\s/g, "")
      .toLowerCase();
    assert.equal(r.toString().replace(/\s/g, "").toLowerCase(), str);
    points++;
  ...
  it("can create Square & toString() return value expected", () => {
    ...
    let str = "name: SQ, location: (12,34), w: 56, h: 56"
      .replace(/\s/g, "")
      .toLowerCase();
  ...
  it("can create Circle & toString() return value expected", () => {
    ...
    let str = "name: SQ, location: (12,34), a: 56, b: 56"
      .replace(/\s/g, "")
      .toLowerCase();
    assert.equal(sq.toString().replace(/\s/g, "").toLowerCase(), str);
    points++;
  ...
  it("can create & use Shapes: add(Shape) / remove(name) / remove(Point)", () => {
    ...
    assert.equal(
      sh instanceof Rectangle,
      true,
      "Removed should be instance of Rectangle",
    );
    points++;
    ...
    assert.equal(
      sh instanceof Rectangle,
      false,
      "Removed should not be instance of Rectangle",
    );
    points++;
    ...
    sh = shapes.remove("E1");
    assert.equal(
      sh instanceof Ellipse,
      true,
      "Removed should be instance of Ellipse",
    );
    points++;
    sh = shapes.remove("E1");
    assert.equal(
      sh instanceof Ellipse,
      false,
      "Removed should not be instance of Ellipse",
    );
    points++;
    ...
    assert.equal(
      sh instanceof Ellipse,
      true,
      "Removed by Point should be instance of Ellipse",
    );
    points++;
    ...
    assert.equal(
      sh instanceof Square,
      true,
      "Removed should be instance of Square",
    );
    points++;
    sh = shapes.remove("SQ2");
    assert.equal(
      sh instanceof Square,
      false,
      "Removed should not be instance of Square",
    );
    points++;
    sh = shapes.remove("SQ1");
    assert.equal(
      sh instanceof Circle,
      true,
      "Removed should be instance of Circle",
    );
    points++;
    ...
    assert.equal(
      sh instanceof Circle,
      true,
      "Removed by Point should be instance of Circle",
    );
    points++;
  });
});
